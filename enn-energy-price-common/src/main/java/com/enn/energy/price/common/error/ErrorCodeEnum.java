...
public enum ErrorCodeEnum {
    ...
    PROXY_ELECTRICITY_PRICE_BIND_SYSTEM_TREE_NOT_EXIST("E20010","代购电价绑定企业节点不存在"),
    PROXY_ELECTRICITY_PRICE_BIND_PRICE_VERSION_NOT_EXIST("E20011","代购电价绑定价格版本不存在"),
    PROXY_ELECTRICITY_PRICE_BIND_PRICE_STRUCT_NOT_EXIST("E20012","代购电价绑定价格体系不存在"),
    PROXY_ELECTRICITY_PRICE_BIND_PRICE_STRUCT_RULE_NOT_EXIST("E20013","代购电价绑定时，体系对应电价规则不存在"),
    PROXY_ELECTRICITY_PRICE_EQUIPMENT_ALREADY_BIND("E20014","代购电价已经绑定设备"),
    PROXY_ELECTRICITY_PRICE_BIND_NEXT_VERSION_NOT_EXIST("E20015","代购电价自义定体系时，未找到下一版本体系价格信息"),
    PROXY_ELECTRICITY_PRICE_EQUIPMENT_BIND_NOT_FOUND("E20016","未找到代购电价绑定信息"),
