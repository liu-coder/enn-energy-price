...
@NoArgsConstructor
@AllArgsConstructor
public class CimDayPointPriceResp implements Serializable{

    private String date;
    private String deviceId;
    private String metric;
    private String systemCode;
    private List<CimPointPriceDetail> priceDataList;

    @Data
    @ToString
    @NoArgsConstructor
    @AllArgsConstructor
    static class CimPointPriceDetail{
